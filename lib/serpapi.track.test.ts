...
describe('trackKeyword / fetchSerperOrganicUpTo100', () => {
  ...
  it('uses a single num=100 response when Serper returns more than 10 organics (one snapshot)', async () => {
  ...
  it('paginates with num=10 when num=100 returns at most 10 organics', async () => {
  ...
  it('paginates from page 2 when num=100 returns fewer than 10 organics', async () => {
  ...
  it('falls back to num=10 page=1 when num=100 fails', async () => {
    mocked
