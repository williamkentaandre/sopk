  ...
  return (
    <div style={{ flex: '0 0 auto', width: 'min(280px, 100%)' }} aria-hidden>
      ...
      >
        ...
        <rect width="280" height="200" rx="12" fill={`url(#${gradientId})`} stroke="#bbf7d0" strokeWidth="1" />
        <text x="140" y="28" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="14" fontWeight="600" fill="#166534">
          {title}
        </text>
        <circle cx="40" cy="55" r="14" fill="#166534" />
        <text x="40" y="59" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="14" fontWeight="700" fill="white">
          1
        </text>
        <path d="M62 48 L62 62 L98 62 L98 48 Z M62 52 L80 58 L98 52" stroke="#166534" strokeWidth="2" fill="none" strokeLinecap="round" />
        <text x="115" y="58" fontFamily="system-ui, sans-serif" fontSize="12" fill="#374151">
          {step1}
        </text>
        <circle cx="40" cy="105" r="14" fill="#166534" />
        <text x="40" y="109" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="14" fontWeight="700" fill="white">
          2
        </text>
        ...
        <text x="115" y="108" fontFamily="system-ui, sans-serif" fontSize="12" fill="#374151">
          {step2}
        </text>
        <circle cx="40" cy="155" r="14" fill="#166534" />
        <text x="40" y="159" textAnchor="middle" fontFamily="system-ui, sans-serif" fontSize="14" fontWeight="700" fill="white">
          3
        </text>
        ...
        <text x="115" y="158" fontFamily="system-ui, sans-serif" fontSize="12" fill="#374151">
          {step3}
        </text>
